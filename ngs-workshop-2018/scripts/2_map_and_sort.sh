...
# son
bwa mem -t 24 -M -R ${RG_son} $REF $DATA/HG002_son_R1_001.fastq.gz \
$DATA/HG002_son_R2_001.fastq.gz > HG002_son.sam

# father
bwa mem -t 24 -M -R ${RG_father} $REF $DATA/HG003_father_R1_001.fastq.gz \
$DATA/HG003_father_R2_001.fastq.gz > HG003_father.sam

# mother
bwa mem -t 24 -M -R ${RG_mother} $REF $DATA/HG004_mother_R1_001.fastq.gz \
