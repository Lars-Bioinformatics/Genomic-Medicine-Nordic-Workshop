...
dbsnp=${project}/resources/Homo_sapiens_assembly38.dbsnp138.vcf.gz
mills_1000g=${project}/resources/Mills_and_1000G_gold_standard.indels.hg38.vcf.gz
phase1_1000g=${project}/resources/1000G_phase1.snps.high_confidence.hg38.vcf.gz
